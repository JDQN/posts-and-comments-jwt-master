...
public class AddRelevanceVoteUseCase extends UseCaseForCommand<AddRelevanceVoteCommand> {

    private final DomainEventRepository repository;
    private final EventBus bus;

    @Override
    public Flux<DomainEvent> apply(Mono<AddRelevanceVoteCommand> addRelevanceVoteCommandMono) {
        return addRelevanceVoteCommandMono.flatMapMany(command -> repository.findById(command.getPostId())
                .collectList()
